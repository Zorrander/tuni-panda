...
class Panda:
    def __init__(self, stepsize=1e-3, realtime=0):
        ...
        try:
            # load models
            p.setAdditionalSearchPath("franka-pybullet/models")
            ...
            # load models
            p.setAdditionalSearchPath("/home/alex/catkin_ws/src/imitation_learning_ros/src/imitation_learning_ros_v2/franka-pybullet/models")
    ...
    def step(self, target_torque, simsteps=20):
        self.setTargetPositions(target_torque)

        for i in range(simsteps):
            self.sim_step()

        euler_pose = self.getEEStates_euler()
