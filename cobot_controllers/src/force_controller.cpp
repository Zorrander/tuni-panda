...
#include <cobot_controllers/force_controller.h>
...
bool ForceExampleController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_desired_mass_param_ = std::make_unique<
      dynamic_reconfigure::Server<cobot_controllers::desired_mass_paramConfig>>(
...
void ForceExampleController::desiredMassParamCallback(
    cobot_controllers::desired_mass_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(cobot_controllers::ForceExampleController,
