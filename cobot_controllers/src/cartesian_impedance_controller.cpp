...
bool CartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<cobot_controllers::compliance_paramConfig>>(
...
void CartesianImpedanceController::complianceParamCallback(
    cobot_controllers::compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(cobot_controllers::CartesianImpedanceController,
