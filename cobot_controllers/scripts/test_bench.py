...
from cobot_msgs.msg import Test
...
class TestBench(object):
    def __init__(self):
        ...
        self.reset_sub = rospy.Subscriber("/move_start", Empty, self.move_to_start)
    ...
    def horizontal_move(self, value):
        ...
        print(next_point)
        next_point.position.x += value/100
    ...
    def horizontal_move2(self, first_pose, value, rep):
        ...
        next_point.position.x += (value/100)*rep
        self.move_group(next_point)
        self.clear_group()
