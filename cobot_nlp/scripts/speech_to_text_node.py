...
def sphinx_callback(recognizer, audio):
    ...
    try:
        ...
        cmd = recognizer.recognize_sphinx(audio, keyword_entries=[("pass", 1.0), ("reach", 1.0), ("grasp", 1.0), ("open", 1.0)])
        print(cmd.strip())
        publisher.publish(cmd.strip())
...
if __name__ == '__main__':
    ...
    try:
        ...
        stop_listening = r.listen_in_background(m, sphinx_callback)
        rospy.spin()
